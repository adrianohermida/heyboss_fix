        ...
        <div className="rounded-[2.5rem] p-8 sm:p-12 shadow-2xl bg-[var(--color-cardElevated)] border border-[var(--color-border)]/10">
          ...
          {!result ? (
            <div className="space-y-8">
              ...
              <button 
                onClick={calculate}
                className="w-full py-5 rounded-2xl font-extrabold text-xl shadow-lg transition-all hover:scale-[1.02] active:scale-95 focus-visible:ring-2"
                style={{ background: 'var(--color-accent)', color: 'var(--color-on-accent, #fff)', boxShadow: '0 2px 12px 0 var(--color-shadow-accent)' }}
              >
